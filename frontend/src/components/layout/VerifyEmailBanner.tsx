...
export function VerifyEmailBanner() {
  ...
  return (
    <div className="bg-ink/5 dark:bg-white/5 border-b border-ink/15 dark:border-white/15 text-sm px-4 sm:px-6 py-2.5 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-center">
      <span>✉️ Please verify your email address to secure your account — the link may land in your <span className="font-semibold">spam / junk folder</span>, so check there too.</span>
      {sent ? (
        <span className="font-semibold text-ink dark:text-white">Verification email sent — check your inbox and spam folder.</span>
      ) : (
