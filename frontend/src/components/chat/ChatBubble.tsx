...
export function ChatBubble({ turn }: { turn: ChatTurn }) {
  ...
  return (
    <div className="flex justify-start gap-2">
      ...
      <div className="max-w-[80%] rounded-2xl rounded-bl-sm bg-white dark:bg-[#141414] border border-ink/10 dark:border-white/10 px-4 py-2.5 text-sm shadow-card whitespace-pre-wrap">
        {turn.text}
      </div>
    </div>
  );
