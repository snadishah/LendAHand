    ...
    <div className="card p-4 space-y-2">
      ...
      {PROMPTS.map((p) => (
        <button
          ...
          className="w-full text-left text-sm rounded-xl px-3 py-2.5 bg-ink/5 dark:bg-white/5 hover:bg-purple/10 hover:text-purple transition-colors disabled:opacity-50"
        >
          {p.icon} {p.text}
        </button>
      ))}
